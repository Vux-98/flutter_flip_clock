...
class FlipClock extends StatelessWidget {
  ...
  FlipClock.reverseCountdown({
    ...
    this.width = 24.0,
        ...
        startTime = DateTime(2023, 0, 0, 0, 0, duration.inSeconds),
        _showHours = true,
        _showDays = false,
        timeLeft = duration {
    _digitBuilder = (context, digit) => Container(
  ...
  Widget build(BuildContext context) {
    ...
    if (_showDays!) {
      digitList.addAll([
        _buildSegment(
            timeStream, (DateTime time) => (timeLeft!.inDays > 99) ? 9 : (timeLeft!.inDays ~/ 10), (DateTime time) => (timeLeft!.inDays > 99) ? 9 : (timeLeft!.inDays % 10), startTime!, "days"),
        Column(
          children: <Widget>[
            Padding(
              padding: spacing!,
